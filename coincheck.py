...
class Coincheck(object):
    ...
    def order_books(self, params=None):
        endpoint = self.url + '/api/orderbooks'
        return self._request(endpoint=endpoint, params=params)

    def balance(self):
        endpoint = self.url + '/api/acconts/balance'
        return self._request(endpoint=endpoint)
    ...
    def transaction(self):
        enpoint = self.url + '/api/exchange/orders/transactions'
        return self._request(endpoint=enpoint)
